...
def register(request: Request, email: str=Form(...), password: str=Form(...), db:Session=Depends(get_db)):
    ...
    try:
        ...
        return responses.RedirectResponse("/?alert=Successfully%20Registered", status_code=status.HTTP_302_FOUND) # status code used for specifying post redirect
    except DuplicateUserError as e:
        # Handle the specific duplicate user error
